...
<head>
	...
	<link rel="stylesheet" href="<?php echo site_url('mods/bootstrap/css/bootstrap.min.css'); ?>">
	<link rel="stylesheet" href="<?php echo site_url('mods/font-awesome/css/font-awesome.min.css'); ?>">
	<link rel="stylesheet" href="<?php echo site_url('mods/themify-icons.css'); ?>" />
	<link rel="stylesheet" href="<?php echo site_url('themes/material/css/src/fontastic.css'); ?>">
	<link rel="stylesheet" href="<?php echo site_url('mods/alertify/themes/alertify.core.css'); ?>" />
	<link rel="stylesheet" href="<?php echo site_url('mods/alertify/themes/alertify.bootstrap.css'); ?>" />
	<link rel="stylesheet" href="<?php echo site_url('themes/material/css/src/style.default.css'); ?>" id="theme-stylesheet">
...
<body>
			...
			<div class="content-inner">
				...
				<footer class="main-footer">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<p>&copy; <?php echo date('Y'); ?> <?php echo config_item('app_name'); ?> v.<?php echo config_item('app_version'); ?> 
							</div>
	...
	<!-- JavaScript files-->
	<script src="<?php echo site_url('mods/jquery/jquery.min.js'); ?>"></script>
	<script src="<?php echo site_url('mods/popper.js/umd/popper.min.js'); ?>"> </script>
