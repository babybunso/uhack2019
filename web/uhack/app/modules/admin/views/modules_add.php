							...
							<div class="col-md">
								...
								<div class="row">
									...
									<div class="col-sm form-group">
										...
										<?php echo form_input(array('id'=>'package_name', 'name'=>'package_name', 'value'=>set_value('package_name', ' '), 'class'=>'form-control'));?>
							...
							<div class="col-md">
								...
								<div class="row">
									...
									<div class="col-sm form-group">
										...
										<?php echo form_input(array('id'=>'copyright_link', 'name'=>'copyright_link', 'value'=>set_value('copyright_link', ' '), 'class'=>'form-control'));?>
