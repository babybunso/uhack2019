<link href="<?php echo site_url('mods/datatables.net-bs4/css/dataTables.bootstrap4.css'); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo site_url('mods/datatables.net/js/jquery.dataTables.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('mods/datatables.net-bs4/js/dataTables.bootstrap4.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('mods/datatables.net-responsive/js/dataTables.responsive.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('mods/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js'); ?>" type="text/javascript"></script>
