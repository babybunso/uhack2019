...
class Images extends MX_Controller 
{
	...
	function form($action = 'add', $id = FALSE)
	{
		...
		// render the page
		$this->template->set_template('modal');
		$this->template->add_css('mods/dropzone/dropzone.min.css');
		$this->template->add_css('mods/dropzone/zone/dropzone.css');
		$this->template->add_js('mods/dropzone/dropzone.min.js');
		$this->template->add_js('mods/dropzone/zone/dropzone.js');
