	...
	<?php echo form_open(current_url(), array('id' => 'form'));?>
		...
		<div class="form-group">
			...
			<?php elseif ($config->config_type == 'textarea'): ?>
				<?php echo form_textarea(array('id'=>'config_value', 'name'=>'config_value', 'rows'=>'10', 'value'=>set_value('config_value', isset($config->config_value) ? $config->config_value : '', FALSE), 'class'=>'form-control')); ?>
